...
const flash = computed<FlashProps>(() => {
    return {
        success: "Hello world I am a success message",
        // error: "Hello world"
    }
});
...
<template>
    <div v-if="(flash.success || flash.error) && showMessage"
        ...
        <div v-if="flash.success" class="animate-slide-up backdrop-blur-md bg-white/30 dark:bg-gray-900/30
            ...
            <div class="flex items-center gap-3 py-4 px-4">
                ...
                <span class="text-gray-800 dark:text-gray-200 font-medium">{{ flash.success }}</span>
            </div>
        ...
        <div v-if="flash.error" class="animate-slide-up backdrop-blur-md bg-white/30 dark:bg-gray-900/30
            ...
            <div class="flex items-center gap-3 py-4 px-4">
                ...
                <span class="text-gray-800 dark:text-gray-200 font-medium">{{ flash.error }}</span>
            </div>
            <button @click="showMessage = false" class="self-start p-3 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300
                       transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
